...
# google colab link -> https://colab.research.google.com/drive/1ZNmh0re6jigaD7l2W0tdgrTOKo2Bp6_Y?usp=sharing
...
def astar_forward(): # function for calling the astar Algorithm and making repeated Astar calls
    ...
    end_time = time.time()
    print("Total_Time Forward-Astar ",end_time-start_time)
    open_list.remove_all()


def Compute_Path_Adaptive(search1, open_list1, closed_list1, g1, f1, h1, maze1, counter1): # functions that perform the Astar Algorithm
    search_path = {}
    ct = 0
...
def astar_adaptive(): # function for calling the astar Algorithm and making repeated Astar calls
    start_time = time.time()
